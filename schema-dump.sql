...
\restrict 2fvdeiEX5a2y2XfwxxvxyhMSBCC1ynF2PUOoIzSZGbDLH3VjUyW9MtHaDVOjUjq
...
--
-- Name: beatmaps; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.beatmaps OWNER TO neondb_owner;
...
CREATE TABLE public.scores (
    ...
    beatmap_id character varying(255) NOT NULL,
    user_id uuid NOT NULL,
    volforce double precision
);
...
--
-- Name: beatmaps beatmaps_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: scores fk5071qsh60bxctyg7yypjix5n9; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.scores
    ADD CONSTRAINT fk5071qsh60bxctyg7yypjix5n9 FOREIGN KEY (beatmap_id) REFERENCES public.beatmaps(id);


--
-- Name: scores fktkgoiahryd4yntgywbqyyw8o8; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
\unrestrict 2fvdeiEX5a2y2XfwxxvxyhMSBCC1ynF2PUOoIzSZGbDLH3VjUyW9MtHaDVOjUjq
